...
export default function TentangPage() {
  return (
    <div style={{ minHeight: "100vh", background: T.bg, color: T.ink }}>
      ...
      {/* ─── Intro Prose ─── */}
      <section style={{ maxWidth: 700, margin: "0 auto", padding: `${φ.xl}px ${φ.lg}px` }}>
      ...
      {/* ─── Divider ─── */}
      <div style={{ maxWidth: 700, margin: "0 auto", padding: `0 ${φ.lg}px` }}>
      ...
      {/* ─── Team Cards ─── */}
      <section style={{ maxWidth: 700, margin: "0 auto", padding: `${φ.lg}px ${φ.lg}px ${φ.xxl}px` }}>
      ...
      {/* ─── Closing ─── */}
      <section style={{ background: T.invBg, padding: `${φ.xl}px ${φ.lg}px` }}>
      ...
      {/* ─── CTA ─── */}
      <section style={{ maxWidth: 700, margin: "0 auto", padding: `${φ.xl}px ${φ.lg}px`, textAlign: "center" }}>
        <p style={{
